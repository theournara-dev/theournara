...
type Optional<TTarget, TKey extends keyof TTarget> = Pick<Partial<TTarget>, TKey> & Omit<TTarget, TKey>;
...
export { type FetchQueryOptions as $, type QueryKeyHashFunction as A, type GetNextPageParamFunction as B, CancelledError as C, type DefaultError as D, type InfiniteData as E, type QueryMeta as F, type GetPreviousPageParamFunction as G, type NetworkMode as H, type InitialDataFunction as I, type NotifyOnChangeProps as J, type QueryOptions as K, type InitialPageParam as L, MutationCache as M, type NoInfer as N, type InfiniteQueryPageParamsOptions as O, type PlaceholderDataFunction as P, QueryCache as Q, type Register as R, type SkipToken as S, type ThrowOnError as T, type Updater as U, type QueryObserverOptions as V, type WithRequired as W, type Optional as X, type DefaultedQueryObserverOptions as Y, type InfiniteQueryObserverOptions as Z, type DefaultedInfiniteQueryObserverOptions as _, type QueryCacheNotifyEvent as a, addToEnd as a$, type EnsureQueryDataOptions as a0, type FetchInfiniteQueryOptions as a1, type ResultOptions as a2, type RefetchOptions as a3, type InvalidateQueryFilters as a4, type RefetchQueryFilters as a5, type InvalidateOptions as a6, type ResetOptions as a7, type FetchNextPageOptions as a8, type FetchPreviousPageOptions as a9, type MutationObserverBaseResult as aA, type MutationObserverIdleResult as aB, type MutationObserverLoadingResult as aC, type MutationObserverErrorResult as aD, type MutationObserverSuccessResult as aE, type MutationObserverResult as aF, type QueryClientConfig as aG, type DefaultOptions as aH, type CancelOptions as aI, type SetDataOptions as aJ, type NotifyEventType as aK, type NotifyEvent as aL, type QueryBehavior as aM, type ObserverFetchOptions as aN, type NotifyOptions as aO, type QueryTypeFilter as aP, noop as aQ, functionalUpdate as aR, isValidTimeout as aS, timeUntilStale as aT, hashQueryKeyByOptions as aU, partialMatchKey as aV, shallowEqualObjects as aW, isPlainArray as aX, isPlainObject as aY, sleep as aZ, replaceData as a_, type QueryStatus as aa, type FetchStatus as ab, type QueryObserverBaseResult as ac, type QueryObserverPendingResult as ad, type QueryObserverLoadingResult as ae, type QueryObserverLoadingErrorResult as af, type QueryObserverRefetchErrorResult as ag, type QueryObserverSuccessResult as ah, type DefinedQueryObserverResult as ai, type QueryObserverResult as aj, type InfiniteQueryObserverBaseResult as ak, type InfiniteQueryObserverPendingResult as al, type InfiniteQueryObserverLoadingResult as am, type InfiniteQueryObserverLoadingErrorResult as an, type InfiniteQueryObserverRefetchErrorResult as ao, type InfiniteQueryObserverSuccessResult as ap, type DefinedInfiniteQueryObserverResult as aq, type InfiniteQueryObserverResult as ar, type MutationKey as as, type MutationStatus as at, type MutationMeta as au, type MutationFunction as av, type MutationOptions as aw, type MutationObserverOptions as ax, type MutateOptions as ay, type MutateFunction as az, QueryClient as b, addToStart as b0, type Action$1 as b1, getDefaultState as b2, type Retryer as b3, type RetryValue as b4, type RetryDelayValue as b5, canFetch as b6, createRetryer as b7, type FetchContext as b8, type FetchDirection as b9, type FetchMeta as ba, type FetchOptions as bb, type Action as bc, type SetStateOptions as bd, type QueryStore as be, QueryObserver as c, type MutationCacheNotifyEvent as d, MutationObserver as e, matchMutation as f, type MutationFilters as g, hashKey as h, isServer as i, type QueryFilters as j, keepPreviousData as k, isCancelledError as l, matchQuery as m, type QueryState as n, Query as o, Mutation as p, type MutationState as q, replaceEqualDeep as r, skipToken as s, type QueryKey as t, dataTagSymbol as u, type DataTag as v, type QueryFunction as w, type QueryPersister as x, type QueryFunctionContext as y, type QueriesPlaceholderDataFunction as z };
